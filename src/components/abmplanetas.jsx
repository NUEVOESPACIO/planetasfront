        ...
        <table style={styles.table}>
          ...
          <tbody>
            {planetas.map((p, index) => {
              ...
              return (
                <React.Fragment key={p.id_planeta}>
                  <tr style={styles.row}>
                    <td><input style={styles.input} value={p.nombre}
                      onChange={(e)=>handleChange(index,"nombre",e.target.value)}
                      disabled={deshabilitado}/></td>

                    <td><input style={styles.input} value={p.nombre_cientifico}
                      onChange={(e)=>handleChange(index,"nombre_cientifico",e.target.value)}
                      disabled={deshabilitado}/></td>

                    <td><input style={styles.inputSmall} value={p.masa}
                      onChange={(e)=>handleChange(index,"masa",e.target.value)}
                      disabled={deshabilitado}/></td>

                    <td><input style={styles.inputSmall} value={p.diametro}
                      onChange={(e)=>handleChange(index,"diametro",e.target.value)}
                      disabled={deshabilitado}/></td>

                    <td><input style={styles.input} value={p.caracteristicas}
